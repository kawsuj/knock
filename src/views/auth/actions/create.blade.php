...
@section('breadcrumb')
	...
	<li><a href="{{asset('/knock/tags/'.$role->tag->id.'/roles/'.$role->id) }}">{{$role->name}}</a></li>
	
	<li class="active">new-user-action</li>
@stop
@section('content')
			...
			<div class="panel panel-default" align="center">
				<div class="zero-clipboard">
					<div class="btn-clipboard-left">
						<span class="knock-action-corner-label knock-action-color"><i class="fa fa-hand-o-right"></i>&nbsp;NEW USER-ACTION</span>
					</div>
				</div>
